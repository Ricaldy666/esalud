  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      >
        ...
        <span className="font-mono text-sm font-medium text-gray-900">{form.sheetName}</span>
  ...
  return (
    <div className="ml-6">
      ...
      >
        ...
        <span className="font-mono text-xs font-medium text-gray-700">{section.codigo}</span>
        <span className="text-xs text-gray-500 truncate">{section.titulo}</span>
            ...
            <tbody>
              {section.fields.map((field, idx) => {
                ...
                const reglaTipo = regla
                  ...
                  : null
                return (
                  <tr key={`${field.codigo}-${idx}`} className="border-t border-gray-50">
                    <td className="py-1 px-2 font-mono text-gray-700">{field.codigo}</td>
